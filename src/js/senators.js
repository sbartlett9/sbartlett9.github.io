                        ...
                        data.forEach(function (e) {
                            ...
                            if (temp_id == e.govtrack_id) {
                                ...
                                div.transition()
                                    ...
                                    .style("opacity", .9);
                                div.html(imgURL 
								+ '<span><p class="Senator_Name">' + e.first_name + ' ' + e.last_name + '</p></span>' 
								+ '<span><p class="Senator_State_Party">' + e.state + ' | ' + e.party + '</p></span>'
								+ '<span><p class="total_contribution_amount">' + 'Total Amount Received:'+ e.total + '</p></span>'
								+ '<span><p class="top_contributor">' + 'Top Contributors:'+'</p></span>'
								)
